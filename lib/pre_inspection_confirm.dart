...
class PreInspectionConfirmation extends StatefulWidget {
  final Map<String, dynamic> bookingDetails;
  final VoidCallback onConfirm;
  final VoidCallback onCancel;

  const PreInspectionConfirmation({
    Key? key,
  ...
  @override
  State<PreInspectionConfirmation> createState() =>
      _PreInspectionConfirmationState();
}

class _PreInspectionConfirmationState extends State<PreInspectionConfirmation> {
  bool isLoading = true;

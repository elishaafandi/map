...
class AddBicycleForm extends StatefulWidget {
  @override
  _AddBicycleFormState createState() => _AddBicycleFormState();
}

class _AddBicycleFormState extends State<AddBicycleForm> {
  final _formKey = GlobalKey<FormState>();

  String _vehicleType = 'Bicycle';
  String _bicycleType = 'Mountain';
  String _vehicleName = '';
  double _pricePerHour = 3.0;
  bool _availability = true;

  final _bicycleTypes = ['Mountain', 'Road', 'Hybrid', 'City', 'BMX'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            Text('Add Bicycle', style: TextStyle(fontWeight: FontWeight.w600)),
        backgroundColor: Colors.yellow[700],
        elevation: 0,
      ),
            ...
            Container(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.pedal_bike, size: 60, color: Colors.yellow[700]),
                    SizedBox(height: 16),
                    Text(
                      'List Your Bicycle',
                      style: TextStyle(
                    ...
                    SizedBox(height: 8),
                    Text(
                      'Enter your bicycle details below',
                      style: TextStyle(
